...
import { IconButton, Button, Alert, AlertIcon, Spinner } from "@chakra-ui/react";
	...
	const onSubmit = (userData) => {
		...
		AdminRequest.update(username, userData)
			.then((data) => {
				...
				setAlert({
					...alert,
					message: "500: Impossible de se connecter au serveur. Veuillez réessayer plus tard.",
					status: "error",
					shouldDisplay: true,
				});
				return false;
					...
					<Flex direction='row' w='100%'>
						...
						<Box
							...
							<Flex m='25px 0px' direction='column' alignItems='center'>
								<AvatarPicture user={user} usesUsername={usesUsername} ref={imageRef} />
								<input
									type='file'
									name='avatar'
									id='avatar'
									...
									style={{ display: "none" }}
								/>
								<HStack flexDirection={!usesUsername && !newAvatar ? "row" : "column"}>
									<Button
