				...
				<Flex direction='row' w='90%'>
					...
					<Box
						...
						<Flex m='25px 0px' direction='column' alignItems='center'>
							...
							<HStack w='100%' fontSize={15} justifyContent='center' alignItems='center' mb='25px'>
								...
								{user.role.id === 3 && (
									<>
										<Icon fontSize={20} color='green.500' as={HiShieldExclamation} />
							...
							<HStack
								...
								<Text fontFamily='Roboto Light'>
									À rejoint en {moment(new Date(user.created_at)).format("MMMM YYYY")}
								</Text>
							</HStack>
