...
const UserCreate = () => {
	...
	const removeImage = () => {
		if (
			(document.getElementById("avatar") && document.getElementById("avatar").value !== "") ||
	...
	return (
		<TopContainer alignItems='center'>
			...
			<form style={{ width: "90%" }} onSubmit={handleSubmit(onSubmit)} ref={formRef}>
						...
						<Flex m='25px 0px' direction='column' alignItems='center'>
							<Flex
								...
								{usesUsername ? (
									...
									<Image w='100%' h='auto' ref={inputRef} src='#' alt='avatar' />
								)}
							</Flex>
							<input
								type='file'
							...
							<HStack>
								...
								{!usesUsername && (
									<IconButton variant='solid' colorScheme='red' onClick={removeImage} icon={<Icon as={HiOutlineX} />} />
								)}
							</HStack>
						</Flex>
					</Box>
